...
if executable('uncrustify')
  autocmd vimrcFileTypeJava BufWinEnter <buffer> let &l:formatprg = 'uncrustify -q -l JAVA ' .
...
elseif executable('astyle')
  autocmd vimrcFileTypeJava BufWinEnter <buffer> let &l:formatprg='astyle --mode=java --style=java ' .
