...
let b:undo_ftplugin = (exists('b:undo_ftplugin') ? b:undo_ftplugin . ' | ' : '') . 'setlocal formatexpr< | unlet! b:prettier_config | silent! autocmd! formatprgsYaml * <buffer>'
