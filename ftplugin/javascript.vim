...
let b:undo_ftplugin = (exists('b:undo_ftplugin') ? b:undo_ftplugin . ' | ' : '') . 'setlocal formatprg< formatexpr<| unlet! b:formatprg_prettier | silent! autocmd! formatprgsJavaScript * <buffer>'
