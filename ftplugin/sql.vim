...
elseif executable('sqlformat')
  autocmd vimrcFileTypeSQL BufWinEnter <buffer> let &l:formatprg='sqlformat --reindent_aligned --indent_width=' . &shiftwidth . ' -'
" From https://github.com/balling-dev/sleek/releases/
elseif executable('sleek')
  autocmd vimrcFileTypeSQL BufWinEnter <buffer> let &l:formatprg='sleek --indent-spaces=' . &shiftwidth . ' -'
endif
