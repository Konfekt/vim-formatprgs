...
if executable('uncrustify')
  autocmd vimrcFileTypeC BufWinEnter <buffer> let &l:formatprg = 'uncrustify -q -l CPP ' .
...
elseif executable('astyle')
  autocmd vimrcFileTypeC BufWinEnter <buffer> let &l:formatprg='astyle --mode=c --style=google ' .
