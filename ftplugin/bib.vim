...
if executable('bibtex-tidy')
  autocmd vimrcFileTypeBib BufWinEnter <buffer> let &l:formatprg = 'bibtex-tidy --quiet ' .
...
elseif executable('prettybib.py')
  autocmd vimrcFileTypeBib BufWinEnter <buffer> setlocal formatprg=prettybib.py
endif
